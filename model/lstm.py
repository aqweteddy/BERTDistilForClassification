    ...
    def __init__(self, hparams, params=None):
        ...
        if params is not None:
            ...
            self.embedding = nn.Embedding.from_pretrained(
                params, freeze=hparams['freeze'], padding_idx=0)
        else:
            self.embedding = nn.Embedding(
                hparams['dct_size'], hparams['embed_size'], 0)
        ...
        # self.fc = nn.Linear(hparams['hid_size'] * 2, hparams['num_classes'])
        self.fc = nn.Sequential(nn.GELU(), nn.Linear(hparams['hid_size'] * 2, hparams['num_classes']))
